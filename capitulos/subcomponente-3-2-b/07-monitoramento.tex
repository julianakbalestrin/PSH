...
implantação física começa em 2028 e termina em 2033. O esgotamento nas
...
\pendencia{A distribuição anual da planilha de custos não bate com as metas
progressivas do Componente~3 (\autoref{tab:metas-componente3}). A tabela do
Componente~3 prevê 126 pessoas com esgotamento em 2027 e 3.000 em 2028. Pela
planilha, não há esgotamento em 2027, e os 245 domicílios de 2028 equivalem a
cerca de 690 pessoas. A planilha também vai até 2033, enquanto as metas do
Componente~3 e o prazo de seis anos do MOP terminam em 2032. Harmonizar as duas
fontes antes de enviar o MOP ao Banco.}

\pendencia{A planilha de custos traz informações que o MOP não menciona. A
linha de esgotamento se chama ``Instalação de sistemas de tratamento de
esgotamento sanitário e implementação de banheiros'', mas o MOP não cita a
construção de banheiros. A planilha fixa 222 sistemas no Programa Sanepar
Rural, número que o MOP não apresenta. E prevê três ``unidades'' de modelo de
gestão, de R\$ 2,3 milhões cada, sem definir o que é uma unidade. Confirmar e,
se for o caso, incorporar ao texto.}
